package com.fracong.util.code.key;
...
public class KeyUtil {
	     ...
	     * @throws Exception
	     */
	    public KeyUtil() throws Exception {
	        this(strDefaultKey);
	    }
		...
		public KeyUtil(String strKey) throws Exception {
	    ...
	    public static void main(String[] args) {
	        try {
	            String test = "fff123456789fff";
	            KeyUtil des = new KeyUtil("justtest");// 自定义密钥
